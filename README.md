...
這題沒有答案。資料記的是「每天最尖峰那一秒，機組出了多少力」，不是「一整天發了多少電」。把每天的數字加起來，等於**把每天中午十二點的車速加起來，當成這個月開了幾公里**。

而且就算單位對也算不出來——台中有幾台機組被併進全系統的合計欄位，拆不回來。

資訊人員看一眼就會說「這不能這樣算」。但只會翻譯的 Text2SQL 不會——SQL 跑得動、圖表畫得漂亮、數字看起來很正常，業務就拿去開會了。

**拿掉中間那個人，也拿掉了那個會喊停的人。**所以系統得自己補上：擋下來、講清楚為什麼，再給幾個問得出答案的問法。

> 「2026 年 7 月全系統尖峰負載最高是哪一天？」
> 「比較 2026 年各月尖峰日的台中燃煤機組出力」

翻譯只是一半。另一半是說「**這題不能這樣問，但你可以這樣問**」——這也是為什麼這個專題的力氣大多花在守門，而不是產生 SQL。
