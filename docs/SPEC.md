...
**範圍問句帶了限定詞就不是範圍問句。** 近似比對接住「目前有哪些電廠」這種贅字變體，但多出來的字必須**全部**在贅字白名單裡。用白名單而不是限定詞黑名單，是因為贅字的集合小而穩定，限定詞的集合是開放的：燃料、地區、電廠名、年份，寫不完。實測不這樣做的代價是 16 種限定詞乘 6 種問法共 96 種組合全部誤接，「火力電廠有哪些」與「水力電廠有哪些」回同一份 22 座電廠的清單，而畫面上沒有任何異狀。

同樣的理由，**近似問法建議也不能把限定詞弄丟**：「核能電廠有哪些」最接近的是「有哪些電廠」，但後者的答案是全部 22 座火水力電廠。推一個答案不同的問法，比誠實說答不出來更糟。

燃料別限定的電廠清單則由 router 真的答出來（火力＝煤＋天然氣＋輕柴油＋重油，水力＝水）。核能、風力、太陽能、地熱**刻意不列**：核能機組另有來源但沒有進機組主檔，再生能源場站在 `v_re_generation`；給它們一份空清單會回一張空表，看起來像「沒有核能電廠」，那是另一種騙人。
